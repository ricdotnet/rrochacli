...
running command...
$ rrochacli (--version)
rrochacli/0.0.5 darwin-x64 node-v16.13.0
...
_See code: [dist/commands/publish.ts](https://github.com/ricdotnet/rrochacli/blob/v0.0.5/dist/commands/publish.ts)_
<!-- commandsstop -->
